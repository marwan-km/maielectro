...
export const categories = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'spares-screens', name: 'Écrans', path: '/category/pieces-detachees?sub=ecrans' },
      { id: 'spares-batteries', name: 'Batteries', path: '/category/pieces-detachees?sub=batteries' },
      { id: 'spares-keyboards', name: 'Claviers', path: '/category/pieces-detachees?sub=claviers' },
      { id: 'spares-chargers', name: 'Chargeurs', path: '/category/pieces-detachees?sub=chargeurs' },
      { id: 'spares-ssd-ram', name: 'SSD / RAM', path: '/category/pieces-detachees?sub=ssd-ram' },
    ],
  },
